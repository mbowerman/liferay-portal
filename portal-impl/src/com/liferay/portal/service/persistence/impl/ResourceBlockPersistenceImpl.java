...
public class ResourceBlockPersistenceImpl extends BasePersistenceImpl<ResourceBlock>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME = new FinderPath(ResourceBlockModelImpl.ENTITY_CACHE_ENABLED,
			ResourceBlockModelImpl.FINDER_CACHE_ENABLED,
			ResourceBlockImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByName",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NAME = new FinderPath(ResourceBlockModelImpl.ENTITY_CACHE_ENABLED,
			ResourceBlockModelImpl.FINDER_CACHE_ENABLED,
			ResourceBlockImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByName", new String[] { String.class.getName() },
			ResourceBlockModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(ResourceBlockModelImpl.ENTITY_CACHE_ENABLED,
			ResourceBlockModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ResourceBlock> findByName(String name) {
	 ...
	 */
	@Override
	public List<ResourceBlock> findByName(String name, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ResourceBlock resourceBlock : list) {
					if (!Objects.equals(name, resourceBlock.getName())) {
						list = null;
	 ...
	 */
	@Override
	public ResourceBlock findByName_First(String name,
		OrderByComparator<ResourceBlock> orderByComparator)
		throws NoSuchResourceBlockException {
		ResourceBlock resourceBlock = fetchByName_First(name, orderByComparator);
	 ...
	 */
	@Override
	public ResourceBlock fetchByName_First(String name,
		OrderByComparator<ResourceBlock> orderByComparator) {
		List<ResourceBlock> list = findByName(name, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ResourceBlock findByName_Last(String name,
		OrderByComparator<ResourceBlock> orderByComparator)
		throws NoSuchResourceBlockException {
		ResourceBlock resourceBlock = fetchByName_Last(name, orderByComparator);
	 ...
	 */
	@Override
	public ResourceBlock fetchByName_Last(String name,
		OrderByComparator<ResourceBlock> orderByComparator) {
		...
		List<ResourceBlock> list = findByName(name, count - 1, count,
				orderByComparator);
	...
	public ResourceBlock[] findByName_PrevAndNext(long resourceBlockId,
		...
		try {
			...
			array[0] = getByName_PrevAndNext(session, resourceBlock, name,
					orderByComparator, true);

			array[1] = resourceBlock;

			array[2] = getByName_PrevAndNext(session, resourceBlock, name,
	...
	protected ResourceBlock getByName_PrevAndNext(Session session,
		ResourceBlock resourceBlock, String name,
	...
	public void removeByName(String name) {
		for (ResourceBlock resourceBlock : findByName(name, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "resourceBlock.name IS NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "resourceBlock.name = ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(resourceBlock.name IS NULL OR resourceBlock.name = '')";
	...
	public ResourceBlock updateImpl(ResourceBlock resourceBlock) {
		...
		if (isNew || !ResourceBlockModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((resourceBlockModelImpl.getColumnBitmask() &
				...
				args = new Object[] { resourceBlockModelImpl.getName() };
