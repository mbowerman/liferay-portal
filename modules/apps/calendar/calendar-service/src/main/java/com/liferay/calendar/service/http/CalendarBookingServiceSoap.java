...
public class CalendarBookingServiceSoap {
	...
	public static com.liferay.calendar.model.CalendarBookingSoap updateMasterRecurrence(
		long calendarBookingId, long calendarId,
		...
		throws RemoteException {
		try {
			com.liferay.calendar.model.CalendarBooking returnValue = CalendarBookingServiceUtil.updateMasterRecurrence(calendarBookingId,
